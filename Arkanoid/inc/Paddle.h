...
class Paddle {
private:
    Vector2D pos;       // Pozycja środka
    Vector2D halfSize;
    fix16 angle;

    // Helpery do obliczeń trygonometrycznych (na STM32 zamienisz na tablice LUT)
...
public:
    ...
    Vector2D getSize() const { return halfSize * FIX(2); } // Zwraca pełny rozmiar
